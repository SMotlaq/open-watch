...
void kalman_2d2r_init(Kalman2D2R* hkalman, float Q, float R1, float L){
	hkalman->wy_hat = 0;
	hkalman->dwy_hat = 0;
...
void kalman_2d2r_update(Kalman2D2R* hkalman){
	float T = SAMPLING_TIME;
	...
	float sigma = hkalman->L*hkalman->L*hkalman->Pnn1[0][0]*hkalman->Pnn1[1][1] - pow(hkalman->L*hkalman->Pnn1[0][1],2) + hkalman->L*hkalman->L*hkalman->Pnn1[1][1]*hkalman->R[0] + hkalman->Pnn1[0][0]*hkalman->R[1] + hkalman->R[0]*hkalman->R[1];
	hkalman->K[0][0] = (hkalman->L*hkalman->L*hkalman->Pnn1[0][0]*hkalman->Pnn1[1][1] - pow(hkalman->L*hkalman->Pnn1[0][1],2) + hkalman->Pnn1[0][0]*hkalman->R[1])/sigma;
	hkalman->K[1][0] = (hkalman->L*hkalman->Pnn1[0][1]*hkalman->R[0])/sigma;
	hkalman->K[0][1] = (hkalman->Pnn1[1][0]*hkalman->R[1])/sigma;
	hkalman->K[1][1] = (hkalman->L*(hkalman->Pnn1[0][0]*hkalman->Pnn1[1][1] - hkalman->Pnn1[0][1]*hkalman->Pnn1[1][0] + hkalman->Pnn1[1][1]*hkalman->R[0]))/sigma;
	
	hkalman->wy_hat = -hkalman->K[0][0]*hkalman->wy_hat + hkalman->wy_hat - hkalman->K[0][0]*T*hkalman->dwy_hat + T*hkalman->dwy_hat - hkalman->K[0][1]*hkalman->L*hkalman->dwy_hat + hkalman->K[0][0]*hkalman->z_y + hkalman->K[0][1]*hkalman->z_ay;
	hkalman->dwy_hat = -hkalman->K[1][0]*hkalman->wy_hat - hkalman->K[1][0]*T*hkalman->dwy_hat -hkalman->K[1][1]*hkalman->L*hkalman->dwy_hat + hkalman->dwy_hat + hkalman->K[1][0]*hkalman->z_y + hkalman->K[1][1]*hkalman->z_ay;
	hkalman->pre_wy_hat = hkalman->wy_hat;
	hkalman->pre_dwy_hat = hkalman->dwy_hat;

	hkalman->Pn[0][0] = pow(hkalman->K[0][0],2)*hkalman->Pnn1[0][0] + pow(hkalman->K[0][0],2)*hkalman->R[0] + hkalman->K[0][0]*hkalman->K[0][1]*hkalman->L*hkalman->Pnn1[0][1] + hkalman->K[0][0]*hkalman->K[0][1]*hkalman->L*hkalman->Pnn1[1][0] - 2*hkalman->K[0][0]*hkalman->Pnn1[0][0] + pow(hkalman->K[0][1],2)*pow(hkalman->L,2)*hkalman->Pnn1[1][1] + pow(hkalman->K[0][1],2)*hkalman->R[1] - hkalman->K[0][1]*hkalman->L*hkalman->Pnn1[0][1] - hkalman->K[0][1]*hkalman->L*hkalman->Pnn1[1][0] + hkalman->Pnn1[0][0];
	hkalman->Pn[1][0] = hkalman->K[0][0]*hkalman->K[1][0]*hkalman->Pnn1[0][0] + hkalman->K[0][0]*hkalman->K[1][0]*hkalman->R[0] + hkalman->K[0][0]*hkalman->K[1][1]*hkalman->L*hkalman->Pnn1[0][1] - hkalman->K[0][0]*hkalman->Pnn1[0][1] + hkalman->K[0][1]*hkalman->K[1][0]*hkalman->L*hkalman->Pnn1[1][0] + hkalman->K[0][1]*hkalman->K[1][1]*pow(hkalman->L,2)*hkalman->Pnn1[1][1] + hkalman->K[0][1]*hkalman->K[1][1]*hkalman->R[1] - hkalman->K[0][1]*hkalman->L*hkalman->Pnn1[1][1] - hkalman->K[1][0]*hkalman->Pnn1[0][0] - hkalman->K[1][1]*hkalman->L*hkalman->Pnn1[0][1] + hkalman->Pnn1[0][1];
	hkalman->Pn[0][1] = hkalman->Pn[1][0];
	hkalman->Pn[1][1] = pow(hkalman->K[1][0],2)*hkalman->Pnn1[0][0] + pow(hkalman->K[1][0],2)*hkalman->R[0] + hkalman->K[1][0]*hkalman->K[1][1]*hkalman->L*hkalman->Pnn1[0][1] + hkalman->K[1][0]*hkalman->K[1][1]*hkalman->L*hkalman->Pnn1[1][0] - hkalman->K[1][0]*hkalman->Pnn1[0][1] - hkalman->K[1][0]*hkalman->Pnn1[1][0] + pow(hkalman->K[1][1],2)*pow(hkalman->L,2)*hkalman->Pnn1[1][1] + pow(hkalman->K[1][1],2)*hkalman->R[1] - 2*hkalman->K[1][1]*hkalman->L*hkalman->Pnn1[1][1] + hkalman->Pnn1[1][1];
